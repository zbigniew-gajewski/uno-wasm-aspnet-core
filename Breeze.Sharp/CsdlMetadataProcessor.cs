...
namespace Breeze.Sharp {
  ...
  public class CsdlMetadataProcessor {
    ...
    public void ProcessMetadata(MetadataStore metadataStore, JObject json) {
      ...
      if (mapping != null) {
        ...
        _cSpaceOSpaceMap = new ConcurrentDictionary<string, string>(tmp.ToDictionary(v => (String)v[0], v => (String)v[1]));
      }
    ...
    private EntityType ParseCsdlEntityType(JObject csdlEntityType) {
      ...
      var baseKeyNamesOnServer = new ConcurrentHashSet<string>();
      if (baseTypeVal != null) {
        ...
        baseKeyNamesOnServer = baseEntityType.KeyProperties.Select(dp => dp.NameOnServer).ToConcurrentHashSet();
      }

      var keyVal = csdlEntityType["key"];
      var keyNamesOnServer = keyVal == null
        ? new ConcurrentHashSet<String>()
        : ToEnumerable(keyVal["propertyRef"]).Select(x => (String)x["name"]).ToConcurrentHashSet();

      baseKeyNamesOnServer.ForEach(e => keyNamesOnServer.Add(e));
    ...
    private DataProperty ParseCsdlDataProperty(StructuralType parentType, JObject csdlProperty, ConcurrentHashSet<String> keyNamesOnServer) {
      DataProperty dp;
    ...
    private DataProperty ParseCsdlSimpleProperty(StructuralType parentType, JObject csdlProperty, ConcurrentHashSet<String> keyNamesOnServer) {
      ...
      if (entityType != null) {
        isPartOfKey = keyNamesOnServer != null && keyNamesOnServer.IndexOf(e => e == nameVal) >= 0;
...
//                    defaultValue = isNullable ? null : dataType.DefaultValue;
    ...
    public void CheckStructuralType(StructuralType stType, Object v1, Object v2, String name) {
    ...
    public void CheckProperty(StructuralProperty prop, Object v1, Object v2, String name) {
      if (v1 == null && v2 == null) return;
      if (Object.Equals(v1, v2)) return;
    ...
    private ConcurrentDictionary<String, String> _cSpaceOSpaceMap;
