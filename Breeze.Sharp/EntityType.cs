...
// ###        if (dp == null) Console.WriteLine("EntityType line 38: dp is null!!");
    ...
    public override DataProperty AddDataProperty(DataProperty dp) {
    ...
    public NavigationProperty AddNavigationProperty(NavigationProperty np) {
      np.ParentType = this;
