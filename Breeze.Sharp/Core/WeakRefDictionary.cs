...
namespace Breeze.Core
{
    ...
    public class WeakRefDictionary<TKey, TValue>
    {
        ...
        public void Add(TKey key, TValue value)
        {
            ...
            _inner.TryAdd(key, new WeakReference(EncodeNullObject(value)));
        }
        ...
        public bool Remove(TKey key)
        {
            ...
            return _inner.TryRemove(key, out result);
        }
        ...
        private void CleanAbandonedItems()
        {
            ...
            _inner.Where(kvp => kvp.Value.Target == null)
             ...
             {
                 WeakReference res;
                 _inner.TryRemove(k, out res);
             });

        }

        private ConcurrentDictionary<TKey, WeakReference> _inner = new ConcurrentDictionary<TKey, WeakReference>();
        /// <summary>
